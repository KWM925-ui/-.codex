...
- Remap the clean-snapshot anchor to the active worktree and apply one uniquely
  locked minimal patch candidate.
...
- Remap the anchor to the active worktree immediately.
...
- Read files
- Remap the clean-snapshot anchor to the active worktree
...
- Broad exploration
- Patching the clean snapshot file
